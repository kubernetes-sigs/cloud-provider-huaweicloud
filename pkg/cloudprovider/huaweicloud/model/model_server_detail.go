...
type ServerDetail struct {
	...
	Image *ecsmodel.ServerImage `json:"image"`
	...
	Flavor *ecsmodel.ServerFlavor `json:"flavor"`

	// 弹性云服务器ID，格式为UUID。
	Id string `json:"id"`

	// 弹性云服务器所属安全组列表。
	SecurityGroups []ecsmodel.ServerSecurityGroup `json:"security_groups"`
	...
	// 挂载到弹性云服务器上的磁盘。
	OsExtendedVolumesvolumesAttached []ecsmodel.ServerExtendVolumeAttachment `json:"os-extended-volumes:volumes_attached"`
	...
	OsschedulerHints *ecsmodel.ServerSchedulerHints `json:"os:scheduler_hints,omitempty"`

	// 弹性云服务器所属的企业项目ID。
	EnterpriseProjectId *string `json:"enterprise_project_id,omitempty"`

	// 弹性云服务器系统标签。
	SysTags *[]ecsmodel.ServerSystemTag `json:"sys_tags,omitempty"`

	CpuOptions *ecsmodel.CpuOptions `json:"cpu_options,omitempty"`

	Hypervisor *ecsmodel.Hypervisor `json:"hypervisor,omitempty"`
}
